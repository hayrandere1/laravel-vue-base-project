                        ...
                        <template v-slot:item.process="{ item }">
                            ...
                            <template v-else>
                                <v-btn
                                    ...
                                    size="small"
                                    variant="text"
                                    :href="route('admin.admin.show',item.selectable.id)"
                                >
                                </v-btn>
                                <v-btn
                                    ...
                                    size="small"
                                    variant="text"
                                    :href="route('admin.admin.edit',item.selectable.id)"
                                >
                                </v-btn>
                                <v-btn
...
export default {
    ...
    methods: {
        ...
        deleteItem() {
            ...
            axios.delete(route('admin.admin.destroy', this.deleteData.id)).then(response => {
        ...
        download() {
            ...
            axios.post(route('admin.admin.download'), {
                params: filterDetail
            }).then(response => {
