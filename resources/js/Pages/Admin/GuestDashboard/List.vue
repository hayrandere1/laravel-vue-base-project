                    ...
                    <v-row>
                        ...
                        <v-col md="12" class="text-end">
                            ...
                            <v-btn
                                ...
                                class="me-2"
                                text="Create"
                                :href="route('admin.guest_dashboard.create')"
                            >
                            </v-btn>
                            <v-btn
                                variant="outlined"
                    ...
                    >
                        <template v-slot:item.process="{ item }">
                                <v-btn
                                    ...
                                    size="small"
                                    variant="text"
                                    :href="route('admin.guest_dashboard.show',item.id)"
                                >
                                </v-btn>
                                <v-btn
                                    ...
                                    size="small"
                                    variant="text"
                                    :href="route('admin.guest_dashboard.edit',item.id)"
                                >
                                </v-btn>
                                <v-btn
...
export default {
    ...
    methods: {
        loadItems({page, itemsPerPage, sortBy}) {
            ...
            axios.get(route('admin.guest_dashboard.getData'), {
                params: filterDetail
            }).then(response => {
                this.loading = false;
        ...
        deleteItem() {
            ...
            axios.delete(route('admin.guest_dashboard.destroy', this.deleteData.id)).then(response => {
        ...
        download() {
            ...
            axios.post(route('admin.guest_dashboard.download'), {
                params: filterDetail
            }).then(response => {
