                    ...
                    >
                        <template v-slot:item.manager_count="{ item }">
                            <v-btn
                                ...
                                v-on:click="managerDialog = true; this.managerFilter.roleGroupId=item.id"
                            >
                            </v-btn>
                        </template>
                        ...
                        <template v-slot:item.process="{ item }">
                            ...
                            <template v-else>
                                <v-btn
                                    ...
                                    size="small"
                                    variant="text"
                                    :href="route('manager.manager_role_group.show',item.id)"
                                >
                                </v-btn>
                                <v-btn
                                    ...
                                    size="small"
                                    variant="text"
                                    :href="route('manager.manager_role_group.edit',item.id)"
                                >
                                </v-btn>
                                <v-btn
