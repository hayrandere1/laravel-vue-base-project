                    ...
                    <v-row>
                        ...
                        <v-col md="12" class="text-end">
                            ...
                            <v-btn
                                ...
                                class="me-2"
                                text="Create"
                                :href="route('manager.user.create')"
                            >
                            </v-btn>
                            <v-btn
                                variant="outlined"
                        ...
                        <template v-slot:item.process="{ item }">
                            ...
                            <template v-else>
                                <v-btn
                                    ...
                                    size="small"
                                    variant="text"
                                    :href="route('manager.user.show',item.selectable.id)"
                                >
                                </v-btn>
                                <v-btn
                                    ...
                                    size="small"
                                    variant="text"
                                    :href="route('manager.user.edit',item.selectable.id)"
                                >
                                </v-btn>
                                <v-btn
...
export default {
    ...
    methods: {
        ...
        deleteItem() {
            ...
            axios.delete(route('manager.user.destroy', this.deleteData.id)).then(response => {
        ...
        download() {
            ...
            axios.post(route('manager.user.download'), {
                params: filterDetail
            }).then(response => {
