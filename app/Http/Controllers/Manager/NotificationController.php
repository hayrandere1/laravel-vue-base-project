...
use App\Http\Resources\Manager\NotificationResource;
...
{
    const PREFIX = 'manager.notification';
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('Manager/Notification/List', compact('resource'));
    }
    ...
    public function getData(Request $request)
    {
        ...
        if ($datas->count() === 0 && $request->get('page', 1) > 1) {
            return redirect()->route('manager.notification.index');
        }
